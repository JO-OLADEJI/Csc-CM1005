...
function draw() {
  ///////////////////ADD YOUR CODE HERE///////////////////
  if (det.locationX == 763 && det.locationY < 135) {
    det.speedY = 1;
  } else if (det.locationY == 135 && det.locationX > 390) {
    det.speedX = -1;
    det.speedY = 0;
  } else if (det.locationX == 390 && det.locationY < 195) {
    det.speedX = 0;
    det.speedY = 1;
  } else if (det.locationY == 195 && det.locationX < 700) {
    det.speedX = 1;
    det.speedY = 0;
  } else if (det.locationX == 700 && det.locationY < 322) {
    det.speedY = 1;
    det.speedX = 0;
  } else if (det.locationY == 322 && det.locationX > 200) {
    det.speedX = -1;
    det.speedY = 0;
  } else if (det.locationX == 200 && det.locationY < 447) {
    det.speedY = 1;
    det.speedX = 0;
  } else if (det.locationY == 447 && det.locationX < 575) {
    det.speedX = 1;
    det.speedY = 0;
  } else if (det.locationX == 575 && det.locationY < 572) {
    det.speedY = 1;
    det.speedX = 0;
  } else if (det.locationY == 572 && det.locationX > 260) {
    det.speedX = -1;
    det.speedY = 0;
  } else if (det.locationX == 260 && det.locationY < 635) {
    det.speedY = 1;
    det.speedX = 0;
  } else if (det.locationY == 635 && det.locationX < 700) {
    det.speedX = 1;
    det.speedY = 0;
  } else if (det.locationX == 700 && det.locationY < 700) {
    det.speedY = 1;
    det.speedX = 0;
  }
